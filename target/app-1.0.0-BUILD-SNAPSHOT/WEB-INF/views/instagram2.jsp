...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/instagram2.css'/>">

    <script src="<c:url value='/js/instagram(h_f).js'/>"></script>
    <script src="<c:url value='/js/instagram2.js'/>"></script>
</head>
<body>
<div id="wrap" class="contents_area">
    ...
    <div class="main">
        <form enctype="multipart/form-data" action="<c:url value='/write/save'/>" method="POST">
            <div class="main_imgbox" id="imgArea">

            </div>
            <!-- <input type="file" onchange="show()"> -->
            <div class="filebox">
                <input id="uploadFile" class="upload-name" value="이미지 업로드" placeholder="이미지 업로드">
                <label for="file">파일찾기</label>
                <input type="file" id="file" name="filename">
            </div>
            <div class="main_descbox">
                <textarea name="A_contents" class="main_desc" placeholder="내용 입력"></textarea>
                <div class="main_descbox_bot">
                    <span>0</span>/2200
                </div>
            </div>

            <div class="main_situation">
                <div class="main_situation_top">
                    <div class="main_text">위치추가</div>
                    <div class="main_direction">
                        <svg aria-label="아래쪽 V자형 아이콘" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="16" role="img" viewBox="0 0 24 24" width="16"><title>아래쪽 V자형 아이콘</title><path d="M21 17.502a.997.997 0 0 1-.707-.293L12 8.913l-8.293 8.296a1 1 0 1 1-1.414-1.414l9-9.004a1.03 1.03 0 0 1 1.414 0l9 9.004A1 1 0 0 1 21 17.502Z"></path></svg>
                    </div>
                </div>
                <div class="main_situation_bot">업데이트 예정 기능입니다.</div>
            </div>
            <div class="main_accessibility">
                <div class="main_accessibility_top">
                    <div class="main_text">접근성</div>
                    <div class="main_direction">
                        <svg aria-label="아래쪽 V자형 아이콘" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="16" role="img" viewBox="0 0 24 24" width="16"><title>아래쪽 V자형 아이콘</title><path d="M21 17.502a.997.997 0 0 1-.707-.293L12 8.913l-8.293 8.296a1 1 0 1 1-1.414-1.414l9-9.004a1.03 1.03 0 0 1 1.414 0l9 9.004A1 1 0 0 1 21 17.502Z"></path></svg>
                    </div>
                </div>
                <div class="main_accessibility_bot">
                    대체 텍스트는 시각적으로 사진을 보기 어려운 사람들에게 사진 내용을 설명하는 텍스트입니다. 대체 텍스트는 회원님의 사진에 대해 자동으로 생성되며, 직접 입력할 수도 있습니다.
                </div>
            </div>
            <div class="main_set">
                <div class="main_set_top">
                    <div class="main_text">고급설정</div>
                    <div class="main_direction">
                        <svg aria-label="아래쪽 V자형 아이콘" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="16" role="img" viewBox="0 0 24 24" width="16"><title>아래쪽 V자형 아이콘</title><path d="M21 17.502a.997.997 0 0 1-.707-.293L12 8.913l-8.293 8.296a1 1 0 1 1-1.414-1.414l9-9.004a1.03 1.03 0 0 1 1.414 0l9 9.004A1 1 0 0 1 21 17.502Z"></path></svg>
                    </div>
                </div>
                <div class="main_set_bot">
                    이 게시물의 좋아요 수 및 조회수 숨기기
                    이 게시물의 총 좋아요 및 조회수는 회원님만 볼 수 있습니다. 나중에 게시물 상단에 있는 ··· 메뉴에서 이 설정을 변경할 수 있습니다.
                </div>
            </div>
            <div class="main_share">
                <input type="submit" value="공유하기" class="create_class_btn">
            </div>
        </form>
        </div>
<%--        <div class="main_set">--%>
...
<%--        </div>--%>
<%--        <div class="main_share">--%>
<%--            <div class="main_share_btn">공유하기</div>--%>
<%--        </div>--%>
    </div>
    <div class="footer">
