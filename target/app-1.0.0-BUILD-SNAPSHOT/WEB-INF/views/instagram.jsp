...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/css/instagram.css'/>">

    <script src="<c:url value='/js/instagram(h_f).js'/>"></script>
    <script defer src="<c:url value='/js/instagram.js'/>"></script>
            ...
            <div class="main_box">
                <div class="main_top">
                    <div class="top_left">
                        <div class="my_img">
                            <c:choose>
                                <c:when test="${item.user_photo == null}">
                                    <!-- 프로필 이미지가 없으면 기본 이미지 -->
                                    <img src="./img/로고2.jpg" class="item_img">
                                </c:when>
                                <c:otherwise>
                                    <img src="<c:url value='/img/${item.getUser_photo()}'/>" class="item_img" >
                                </c:otherwise>
                            </c:choose>

<%--                            <div class="back_img"></div>--%>
<%--                            <img src="<c:url value='/img/${item.getUser_photo()}'/>" class="back_img" >--%>
<%--                            <!-- <img src="../인스타그램/로고/로고2.jpg" alt=""> -->--%>
                        </div>
                        <div class="top_name"><a href="/detailArticle?user=${item.getA_writer()}">${item.getA_writer()}</a></div>
                            <%-- 찍히는 방식 변경 예정--%>
...
<%--                        <div class="main_imgbox_img"></div>--%>
                ...
                <div class="main_comment">
                    ...
                    <div class="comment_make">
                        <input type="text" placeholder="댓글달기.." class="commert_text" >
        ...
        <div class="big_comment">
            <div class="bc_pan">
                ...
                <div class="bc_bot">
                    ...
                    <%--                        <div class="bc_item_R">--%>
                    <%--                            <div class="bc_R_top">--%>
                    <%--                                <div class="bc_name">${item.getC_writer()}</div>--%>
                    <%--                                <div class="bc_day">15일</div>--%>
                    <%--                            </div>--%>
                    <%--                            <textarea name="content" id="" class="bc_text" readonly >${item.getC_txt()}</textarea>--%>
                    <%--                            <div class="bc_change">--%>
